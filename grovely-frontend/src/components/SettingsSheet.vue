        ...
        <div class="sheet">
          ...
          <div class="prefs-list">
            ...
            <div class="pref-row pref-row--input">
              ...
              <input class="pref-input" :value="settings.notification_sender_name" @change="e => updateSetting('notification_sender_name', (e.target as HTMLInputElement).value)" placeholder="Grovely 💌" />
            </div>
          </div>
